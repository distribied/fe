...
import wovenTexture from "@/assets/woven-texture.jpg";
  ...
  return <div className="flex items-center justify-between mb-6">
      ...
      <div className="flex items-center">
        ...
        <div className="w-14 h-14 rounded-full overflow-hidden border-2 border-primary flex-shrink-0 bg-background">
          <img src={basketIcon} alt="" className="w-full h-full object-cover" />
        </div>

        {/* Title with woven texture background */}
        <div className="relative -ml-3 pl-6 pr-8 py-2 rounded-r-full overflow-hidden" style={{
        backgroundImage: `url(${wovenTexture})`,
      ...
      {/* View all button */}
      <a href={href} className="flex items-center gap-1 bg-primary text-primary-foreground px-4 py-2 rounded text-sm font-medium hover:opacity-90 transition-opacity">
        Xem Tất Cả
