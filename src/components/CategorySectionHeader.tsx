...
const CategorySectionHeader = ({ title, href = "#" }: CategorySectionHeaderProps) => {
  return (
    <div className="flex items-center justify-between mb-6">
      ...
      <div className="flex items-center">
        ...
        >
          ...
          <h2 className="relative text-primary font-bold text-lg md:text-xl uppercase tracking-wide">
            {title}
          </h2>
        </div>
      </div>
